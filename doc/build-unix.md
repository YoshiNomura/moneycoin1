UNIX BUILD NOTES
====================
Some notes on how to build Moneycoincoin Core in Unix.
...
memory available when compiling Moneycoincoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Moneycoincoin Core without wallet.
...
If you want to build Moneycoincoin-Qt, make sure that the required packages for Qt development
...
# Configure Moneycoincoin Core to use our own-built instance of BDB
cd $LITECOIN_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard Moneycoincoin Core distributions and independently built
