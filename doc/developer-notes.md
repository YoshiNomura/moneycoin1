...
Moneycoincoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- MoneycoincoinMiner : Generates litecoins (if wallet is enabled).
...
However, in open source software such as Moneycoincoin Core, where everyone uses
...
pay attention to for reviewers of Moneycoincoin Core code.

General Moneycoincoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Moneycoincoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
