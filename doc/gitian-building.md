...
*Setup instructions for a Gitian build of Moneycoincoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Moneycoincoin
...
- [Building Moneycoincoin Core](#building-litecoin-core)
...
To build Moneycoincoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
