...
### Moneycoincoin maintainers/release engineers, update version in sources
...
### Build and sign Moneycoincoin Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Moneycoincoin Core announcements list https://groups.google.com/forum/#!forum/litecoin-dev
  ...
  - Optionally twitter, reddit /r/Moneycoincoin, ... but this will usually sort out itself
