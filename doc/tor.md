...
It is possible to run Moneycoincoin as a Tor hidden service, and connect to such services.
...
The first step is running Moneycoincoin behind a Tor proxy. This will already make all
...
Moneycoincoin Core automatically creates a hidden service to listen on. This will positively 
