...
The Moneycoincoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Moneycoincoin Core requires ZeroMQ API version 4.x or
...
using. Moneycoincoind appends an up-counting sequence number to each
