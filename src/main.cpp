...
#if defined(NDEBUG)
# error "Moneycoincoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Moneycoincoin Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Moneycoincoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Moneycoincoin: (mainnet >= 710000, regtest and testnet uses supermajority)
